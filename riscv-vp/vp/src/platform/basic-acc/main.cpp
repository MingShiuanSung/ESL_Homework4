...
public:
	...
	addr_t gaussFilter_start_addr = 0x73000000;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > gaussFilter_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.gaussFilter_start_addr, opt.gaussFilter_end_addr);
	...
	bus.isocks[12].bind(gauss_filter.tsock);
